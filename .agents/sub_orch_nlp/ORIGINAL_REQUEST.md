...
Output requirements:
- Write `handoff.md` in `/home/ijstt/News/.agents/sub_orch_nlp/` summarizing what was done, what was changed, and verification evidence.
