# Scope: NLP Refactoring & Tests (Attempt 3)
...
- Fix Private Imports: `nlp/fundamentals.py` currently imports private symbols (`_MULT`, `_to_float`) from `nlp/numeric.py`. Expose them properly as public API or extract them to a shared `_utils.py` module.
